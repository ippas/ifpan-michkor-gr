...
svg("data/factors-pmid38965376/figures/overlap-v1/combined_p1e5_min3_pthr_locus.svg", width = 28, height = 20)
...
svg("data/factors-pmid38965376/figures/overlap-v1/combined_p1e5_min3_pthr_center.svg", width = 28, height = 20)
(p1 / p2 / p3 / p4 / p5) + plot_layout(guides = "collect") & theme(legend.position = "bottom")
dev.off()
