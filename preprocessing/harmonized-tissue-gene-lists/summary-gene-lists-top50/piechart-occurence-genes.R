...
gene_list_log2ratio_top_50 %>% 
  ...
  mutate(freq_genes = ifelse(cumsum > 0.975, "more_than_7", as.character(freq_genes))) %>% 
  group_by(freq_genes) %>% 
...
svg("results/figures/harmonized-tissue-gene-lists/summary-gene-lists-top50/piechart-gene-list-top50.svg", width = 8, height = 8)
