...
svg("results/figures/harmonized-tissue-gene-lists/summary-gene-lists-top50/boxplot-log2ratio-top50-per-list.svg", width = 8, height = 10)
...
dev.off()
svg("results/figures/harmonized-tissue-gene-lists/summary-gene-lists-top50/boxplot-log2ratio-50genes-tissue.svg", width = 8, height = 10)
ggplot(plot_data_sorted, aes(x = label_figure, y = log2ratio, color = regulation)) +
