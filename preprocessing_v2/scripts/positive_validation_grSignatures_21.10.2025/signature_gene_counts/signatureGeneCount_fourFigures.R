...
# ============================================================
# 🧩 5. Połączenie w układzie 2×2
# ============================================================
combined_plot <- ((p_full | p_cluster) / (p6 | p5)) +
  plot_annotation(title = "Comparison of GR-dependent signatures – gene counts") &
