...
# ============================================================
# 6️⃣➕ NEW: Remove both global UP & DOWN from all tissue signatures
# ============================================================
...
global_updown_4_vec <- unique(c(
  global_GR_genes$globalUp4TissuesDerivedCells,
  global_GR_genes$globalDown4TissuesDerivedCells
))

signaturesMinusGlobalUpDown4TissuesDerivedCells <- list(
  minusGlobalUpDown4TissuesDerivedCells = c(
    remove_global_genes(tissue_up_signatures_genes,   global_updown_4_vec),
    remove_global_genes(tissue_down_signatures_genes, global_updown_4_vec)
  )
)


global_updown_6_vec <- unique(c(
  global_GR_genes$globalUp6TissuesDerivedCells,
  global_GR_genes$globalDown6TissuesDerivedCells
))

signaturesMinusGlobalUpDown6TissuesDerivedCells <- list(
  minusGlobalUpDown6TissuesDerivedCells = c(
    remove_global_genes(tissue_up_signatures_genes,   global_updown_6_vec),
    remove_global_genes(tissue_down_signatures_genes, global_updown_6_vec)
  )
)
...
allGrSignatures_18.11.2025 <- list(
  ...
  signaturesMinusGlobalUpDown4TissuesDerivedCells = signaturesMinusGlobalUpDown4TissuesDerivedCells,
  signaturesMinusGlobalUpDown5TissuesDerivedCells = signaturesMinusGlobalUpDown5TissuesDerivedCells,
  signaturesMinusGlobalUpDown6TissuesDerivedCells = signaturesMinusGlobalUpDown6TissuesDerivedCells
)
...
flat_allGrSignatures_18.11.2025 <- flatten_named_list(allGrSignatures_18.11.2025)

names(flat_allGrSignatures_18.11.2025) <- sapply(names(flat_allGrSignatures_18.11.2025), function(nm) {
...
df_allGrSignatures_18.11.2025 <- map2_df(
  flat_allGrSignatures_18.11.2025,
  names(flat_allGrSignatures_18.11.2025),
...
save_path <- "results_v2/GR_signatures/GR_signatures_18.11.2025"
dir.create(save_path, recursive = TRUE, showWarnings = FALSE)

saveRDS(flat_allGrSignatures_18.11.2025, file = file.path(save_path, "flat_allGrSignatures_18.11.2025.rds"))
saveRDS(allGrSignatures_18.11.2025,      file = file.path(save_path, "allGrSignatures_18.11.2025.rds"))
saveRDS(df_allGrSignatures_18.11.2025,   file = file.path(save_path, "df_allGrSignatures_18.11.2025.rds"))

write_tsv(df_allGrSignatures_18.11.2025, file.path(save_path, "df_allGrSignatures_18.11.2025.tsv"))

wb <- createWorkbook()
addWorksheet(wb, "GR_signatures")
writeData(wb, "GR_signatures", df_allGrSignatures_18.11.2025)
saveWorkbook(wb, file.path(save_path, "df_allGrSignatures_18.11.2025.xlsx"), overwrite = TRUE)

cat("
✅ Saved GR signature objects to: results_v2/GR_signatures/GR_signatures_18.11.2025/
   ├── flat_allGrSignatures_18.11.2025.rds
   ├── allGrSignatures_18.11.2025.rds
   ├── df_allGrSignatures_18.11.2025.rds
   ├── df_allGrSignatures_18.11.2025.tsv
   └── df_allGrSignatures_18.11.2025.xlsx
")
...
flat_sigs_up   <- flat_allGrSignatures_18.11.2025[grepl("Up",   names(flat_allGrSignatures_18.11.2025))]
flat_sigs_down <- flat_allGrSignatures_18.11.2025[grepl("Down", names(flat_allGrSignatures_18.11.2025))]
...
xlsx_path <- file.path(save_path, "GR_signatures_up_down_18.11.2025.xlsx")
...
✅ XLSX file created successfully:
   results_v2/GR_signatures/GR_signatures_18.11.2025/GR_signatures_up_down_18.11.2025.xlsx
