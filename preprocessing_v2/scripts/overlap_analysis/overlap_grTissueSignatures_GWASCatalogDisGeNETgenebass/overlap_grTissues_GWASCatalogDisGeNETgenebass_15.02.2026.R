...
mapperPhenotyeps2icd10 <- read_excel_sheets("data/mapperPhenotypesICD10/manualMapping_phenotype2ICD10categories_28.01.2026.xlsx") %>% 
...
# ---- chi2 analysis ----
# ##############################################################################
GWASCatalogDisGeNETgenebass_GrTissue_overlapChi2 <- run_full_overlap_analysis(
...
GWASCatalogDisGeNETgenebass_phenotypes <- c(
  ...
  "GWASCatalog_G3x_F0x_late-onset Alzheimers disease",
...
GWASCatalogDisGeNETgenebass_GrTissue_overlapChi2$processed$original_data$list$chi2_value_matrix

GWASCatalogDisGeNETgenebass_GrTissue_overlapChi2$processed$original_data$list$log10_number_overlap_matrix <- log10(GWASCatalogDisGeNETgenebass_GrTissue_overlapChi2$processed$original_data$list$number_overlap_matrix + 1)
GWASCatalogDisGeNETgenebass_GrTissue_overlapChi2$processed$original_data$list$log_p_value_matrix <- -log10(GWASCatalogDisGeNETgenebass_GrTissue_overlapChi2$processed$original_data$list$p_value_matrix) 


GWASCatalogDisGeNETgenebass_GrTissue_overlapChi2$processed$original_data$list$score_G <-
  GWASCatalogDisGeNETgenebass_GrTissue_overlapChi2$processed$original_data$list$log10_number_overlap_matrix *
  GWASCatalogDisGeNETgenebass_GrTissue_overlapChi2$processed$original_data$list$log_p_value_matrix 
...
# 
# # output
# out_rdata <- "data/run_RData_inputs/permutation_fdr/rdata2permutationFDR_systemicGR_allSources.RData"
# 
# gene_list <- c(gene_list_disgenet, gene_list_genebass, gene_list_GWASCatalog)
# 
# 
# message("[6/6] 💾 Saving RData package")
# 
