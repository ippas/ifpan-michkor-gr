...
GWASCatalogDisGeNETgenebass_GrSystemic_overlapChi2$processed$original_data$list$log_chi2_value_matrix <- log10(GWASCatalogDisGeNETgenebass_GrSystemic_overlapChi2$processed$original_data$list$chi2_value_matrix + 1)

GWASCatalogDisGeNETgenebass_GrSystemic_overlapChi2$plot_chi2
...
heatmap_overlap_log2OR_complex(
  ...
  # 🔺 triangle mode pełny
  triangle_mode = "full",
  color_key = "log_chi2_value_matrix",
  ...
  tile_gap = 1,
  # save_to_svg = "results_v2/overlap/overlap_GWASCatalogDisGeNETgenebass/figures/heatmap_GRsystemic_GWASCatalogDisGeNETgenebass_log2OR_v2_05.02.2026.svg",
  svg_width = 6.625,
  svg_height = 22,
