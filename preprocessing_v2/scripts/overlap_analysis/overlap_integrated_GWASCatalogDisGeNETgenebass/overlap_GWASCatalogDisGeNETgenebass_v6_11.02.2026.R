...
GWASCatalogDisGeNETgenebass_GrSystemic_overlapChi2$processed$original_data$list$chi2_value_matrix %>% .[c(1:5),c(1:2)]

GWASCatalogDisGeNETgenebass_GrSystemic_overlapChi2$processed$original_data$list$log_chi2_value_matrix %>% .[c(1:5),c(1:2)]


GWASCatalogDisGeNETgenebass_GrSystemic_overlapChi2$processed$original_data$list$log2_odds_ratio_matrix %>% .[c(1:5),c(1:2)]
...
heatmap_overlap_log2OR_complex(
  ...
  # 🎨 skala kolorów
  color_scale_range = c(0, 20),
  text_contrast_range = c(-30, 15),
  ...
  tile_gap = 1,
  save_to_svg = "results_v2/overlap/overlap_GWASCatalogDisGeNETgenebass/figures/heatmap_GRsystemic_GWASCatalogDisGeNETgenebass_log10pvalue_log2overlap_v2_11.02.2026.svg",
  svg_width = 6.625,
  svg_height = 22,
