...
df <- tibble::tibble(
  ...
  mean_cs        = c(2.98, 2.35, 4.33, 6.68, 2.28, 2.02)
)
...
p_mean_cs <- ggplot(
  ...
  geom_col(width = bar_width, fill = bar_fill, color = bar_edge, linewidth = bar_lwd, alpha = 0.7) +
...
out_file <- paste0("meanCS_grSystemic_barplot_", "13.02.2026", ".svg")
