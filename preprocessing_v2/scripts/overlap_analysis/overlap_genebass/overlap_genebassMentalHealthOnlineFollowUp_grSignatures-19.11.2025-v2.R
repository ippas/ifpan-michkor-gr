...
# genebass_online_mental <- read_tsv("data/genebass_v2/all_categories_burden/genebass_burden_Health-related_outcomes_-_First_occurrences_-_Nervous_system_disorders.tsv.bgz") %>%
...
# 
# genebass_online_mental<-genebass_MentalAndBehaviouralDisorders
...
heatmap_overlap_log2OR_complex(
  ...
  tile_gap = 1,
  # save_to_svg = "results_v2/overlap/genebass_overlap/figures/heatmap_allGrSignaturesGenebass_log2OR_13.01.2026.svg",
  svg_width = 10.5, 
  svg_height = 7.2,
...
saveWorkbook(
  wb,
  file = "results_v2/overlap/genebass_overlap/tables/genebasMentalHealthFollowUp_GrSignatures_overlapChi2_15.01.2026.xlsx",
  overwrite = TRUE
)
