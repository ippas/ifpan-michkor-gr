create_rg_heatmap <- function(
  ...
  # =========================================
  # 3. Budowa macierzy + naprawa NA/NaN/Inf
  # =========================================
  ...
  # dodatkowy fix po reorderze, żeby ComplexHeatmap się nie wywalił
  heatmap_matrix[!is.finite(heatmap_matrix)] <- if (absolute_correlation) 0 else 0
