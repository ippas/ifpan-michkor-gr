...
# opcjonalnie: ten sam porządek dla wierszy i kolumn
...
ht <- Heatmap(
  ...
  cell_fun = function(j, i, x, y, width, height, fill) {
    # gwiazdka dla istotnych korelacji
