downloadMedianSubtissuesGTEx_tissueSummaryExpression <- function(
  ...
  # ============================================================
  # 3) Tissue summary (required meta + summary columns)
  # ============================================================
  ...
  tissue_summary <- med2 %>%
    ...
    summarise(
      ...
      median_median = median(.data[[median_col]], na.rm = TRUE),
    ...
    select(
      ...
      tissue,
      n_subtissues, median_mean, median_median, median_sd, median_min, median_max
    )
