plot_tf_heatmap_enrichr_gtex <- function(
  ...
  ## ------------------------------------------------------------
  ## B) Download GTEx summary for TFs (via user's function)
  ## ------------------------------------------------------------
  ...
  ## ------------------------------------------------------------
  ## E) Dots df (global = 3 dots; tissue-specific = 1 dot)
  ## ------------------------------------------------------------
  dots_df <- hm_df %>%
...
plot_tf_heatmap_enrichr_gtex(
  enrichr_list = res$enrichr$overlap_only,
  nuclearReceptors_GO0004879 = nuclearReceptors_GO0004879,
  tile_width = 0.94,
  tile_height = 0.94,
  gtex_threshold = 2,              # <--- zmieniasz próg (0.1, 1, 2, 5, 10)
  dot_size = 3.2
  # svg_file = "TF_heatmap.svg",
  # svg_width = 11,
  # svg_height = 8
)
